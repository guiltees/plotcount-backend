...
MAX_TILE_PX = 512          # API limit per dimension at scale=2 → effective 1280px
SCALE = 1                  # High-DPI mode
TARGET_LONG_EDGE = 480    # Target longest edge for AI pipeline
...
def fetch_satellite_image(
    ...
    Args:
        ...
        size_px: Requested tile width/height in pixels (≤ 512 for scale=1).
